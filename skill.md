...
### For Users (The Vanguard)
*   **💬 General Questions:** Join the **[Discord Community](LINK_TO_DISCORD)**.
*   **💡 Feature Requests:** Post in **[GitHub Discussions](LINK_TO_DISCUSSIONS)** under "Ideas".
*   **🐛 Bug Reports:** Found a broken script? Open a **[GitHub Issue](LINK_TO_ISSUES)**.
*   **🚨 Security Vulnerabilities:** Do **NOT** post publicly. See **[SECURITY.md](SECURITY.md)**.
*   **📣 Success Stories:** Tag **#AISAFE2** on [LinkedIn](https://www.linkedin.com/company/cyber-strategy-institute/), [Instagram](https://www.instagram.com/CyberStrategy1/) and [X/Twitter](https://x.com/CyberStrategy1).

### For Contributors (The Builders)
*   **Code Contributions:** Read **[CONTRIBUTING.md](CONTRIBUTING.md)** before submitting a PR.
*   **Strategic Proposals (RFCs):** Start a discussion in the **[RFC Category](LINK_TO_RFC_DISCUSSIONS)**.
*   **Documentation:** Typos and clarifications are always welcome via PR.

### Maintainers
*   **Lead Architect:** Vincent Sullivan (@CyberStrategy1)
*   **Governance:** Cyber Strategy Institute
*   **Community:** The Vanguard (Join via Discord)
